...
$co=$_GET[co];
$kategorie='gympl_casopis';$kategorie_nazav='Školní èasopis';
...
$seznam_novinek= $pro_seznam_novinek->VyberSeznamNovinekAktualnich();
	$filtrovanysloupec='archiv';$mahodnotu='ne'; $nazev_vyfiltrovane_polozky=' -&nbsp; aktuální vydání';	
}
...
$nazev[$i]=$seznam_novinek[nadpis][$i];
 ...
 if ($zobr=='') {
echo"
  <a href=\"gympl_casopis.php?co=$co \" class=\"tlacitkopodmenuakt\">Pøehled vydání</a>
     "; 	
 } 
 else {
  echo"
  <a href=\"gympl_casopis.php?co=$co \" class=\"tlacitkopodmenu\">Pøehled vydání</a>
     ";	
 } 
...
echo" 
<a href=\"?co= \" class=\"tlacitkopodmenuarchiv\"> Aktuální vydání</a>";	
}                                          
echo" 
