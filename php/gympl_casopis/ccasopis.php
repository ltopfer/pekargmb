...
if($this->pocetobr()<5000) {echo"<tr><td colspan=\"2\"  class=\"centrovano\" > Mùžete pøidat k textu 2obrázky, 
max. 8MB,formát *.jpg,doporuèené  rozmìry: šíøka 250px (jeden obr.), 150px (dva obr.) <br />
nebo 2soubory *.pdf,  max. 8MB  <br />
...
echo"<div class=\"centrovano\">    
 ...
 <tr class=\"nadpisv-n-c \" ><td><a href=\"?zobr=".''.'&amp;co='.$co."\" > <img src=\"../obr/zavri.gif\" alt=\"zavri.gif, 767B\" title=\"zavøít\" border=\"0\" height=\"20\" width=\"20\" class=\"obrvpravobezokraje\"> </a> ".$VybranaNovinka[nadpis]."</td></tr>";
...
if( (file_exists ($adresafotky2))&&($i%2==0)){
echo"<img src=\"$adresafotky2\"  class=\"obrvlevo\" alt=\"foto\" />";
...
if( (file_exists ($adresafotky2))&&($i%2!=0)){
echo"<img src=\"$adresafotky2\" class=\"obrvpravo\" alt=\"foto\" />";
...
echo"<div class=\"centrovano\">";
 ...
 for ($i=0;$i<$pocetstran ;$i++ ) {
  echo"<a href=\"".$this->Nazev.".php?strana=".$i.'&amp;co='.$co."\">|  $i  |</a>"; 	
 } 
echo" </div>";                                             
                    } //zobraz vse                        
