...
<table border=\"1\"  class=\"centrovano\" >
  ...
  case 'autor':
  echo"<tr><td>";echo $this->sloupec[$i]; echo":</td>";
        echo"<td class=\"chyba\"><input type=\"text\" size=\"25\" name=\"".$this->sloupec[$i]."\" value=\"".'PhDr. Zuzana Knesplová'."\" />".$this->chyba[$i]."</td></tr>
            ";
         	break;
 
  case 'email': 
      echo"<tr><td>";echo $this->sloupec[$i]; echo":</td>";
        echo"<td class=\"chyba\"><input type=\"text\" size=\"25\" name=\"".$this->sloupec[$i]."\" value=\"".'knesplova@pekargmb.cz'."\" />".$this->chyba[$i]."</td></tr>
            ";
         	break;
